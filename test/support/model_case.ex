defmodule RemindToContribute.ModelCase do
  @moduledoc """
  ...
  using do
    quote do
      ...
      import Ecto.Query
      import RemindToContribute.ModelCase
    end
  end
  ...
  def errors_on(struct, data) do
    ...
    |> Ecto.Changeset.traverse_errors(&RemindToContribute.ErrorHelpers.translate_error/1)
